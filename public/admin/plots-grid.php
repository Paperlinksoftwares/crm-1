...
<body class="<?= $tv_mode ? 'tv-mode' : '' ?> p-3">
    <div class="container">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
                <a href="../../public/project.php?id=<?= urlencode($project_id) ?>" class="btn btn-link">&larr; Back to project</a>
    ...
    <script>
        (function() {
            ...
            function onTileAct(e) {
                ...
                if (status === 'available') {
                    // go to booking form
                    location.href = '/public/book-plot.php?plot_id=' + encodeURIComponent(plotId) + '&project_id=' + encodeURIComponent(projectId);
                    return;
                }
